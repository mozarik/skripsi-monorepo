...
\begin{figure}[H]
  \centering
  \fcolorbox{black}{white}{\includegraphics[width=0.9\textwidth]{figures/pull-request-code-changes-prime-service-5-return.jpg}}
...
\begin{figure}[H]
  \centering
  \fcolorbox{black}{white}{\includegraphics[width=0.9\textwidth]{figures/hasil-generate-image-baru-prime-service-5-return.jpg}}
...
\begin{figure}[H]
  \centering
  \fcolorbox{black}{white}{\includegraphics[width=0.9\textwidth]{figures/perubahan-image-version-pada-prime-service.png}}
...
\begin{figure}[H]
  \centering
  \fcolorbox{black}{white}{\includegraphics[width=0.9\textwidth]{figures/perubahab-versi-image-pada-argo.png}}
  \caption{Perubahan Versi Image Pada Manifest ArgoCD}
  \label{fig:perubahan-versi-image-pada-argo}
\end{figure}
\begin{figure}[H]
  \centering
  \fcolorbox{black}{white}{\includegraphics[width=0.9\textwidth]{figures/hasil-prime-generator-service-return-5.png}}
  \caption{Hasil Prime Generator Service Return 5}
  \label{fig:hasil-prime-generator-service-return-5}
\end{figure}

Pada \textbf{Gambar \ref{fig:hasil-prime-generator-service-return-5}}
