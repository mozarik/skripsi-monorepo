...
\onehalfspacing
\phantomsection \addcontentsline{toc}{chapter}{PENDAHULUAN}
\include{skripsi/09_bab1_pendahuluan}

\onehalfspacing
\phantomsection \addcontentsline{toc}{chapter}{STUDI LITERATUR}
\include{skripsi/10_bab2_studi_literatur}
